	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-md-offset-2">
				...
				<label class="radio-inline">
					<input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"> Special
				</label>
			</div>
			<div class="col-md-5">
				<form class="horizontal">
					...
					<label for="holidayname"><h3>Name of the Holiday</h3></label>
						<input type="text" class="form-control" id="holidayname" placeholder="Independence Day">
					</div>
				</div>
			</div><hr>
