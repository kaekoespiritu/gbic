...
?>
				...
				<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="row">
								...
								if($sss != 0)
								{
									Print "<input type='checkbox' onchange='sssCheckbox()' class='pull-left' id='sssCheck' name='sssCheck' checked>";
								}
								else
								{
									Print "<input type='checkbox' onchange='sssCheckbox()' class='pull-left' id='sssCheck' name='sssCheck'>";
								}
								?>
	...
	function sssCheckbox() {//SSS checkbox
		var sssCheck = document.getElementById('sssCheck');
		if(sssCheck.checked)
		{
			var monthly = document.getElementById('monthlysalary').value;
			...
			document.getElementById('sss').value = sssContribution;//display the sss
		}
		else
		{
