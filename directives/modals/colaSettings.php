			  ...
			  <div class="modal-dialog" role="document">
			  	<div class="modal-content">
				  	<div class="modal-header">
				  		<h4 class="modal-title col-md-11 col-lg-11">Manage COLA settings</h4>
					    ...
					    <div class="modal-body">
					    	<div class="row">
					    		...
					    		<div class="col-md-3 col-md-offset-2 col-lg-3 col-lg-offset-2">
					    			<a data-target="#addCola" data-toggle="modal" class="btn btn-success col-md-12 col-lg-12 pull-down">ADD COLA</a>
					    			<a data-target="#modifyCola" data-toggle="modal" class="btn btn-primary col-md-12 col-lg-12 pull-down">MODIFY COLA</a>
					    			<a class="btn btn-danger col-md-12 col-lg-12 pull-down" onclick="colaRemove()">REMOVE COLA</a>
					    		</div>
