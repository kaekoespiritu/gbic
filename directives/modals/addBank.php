				    ...
				    <form method="POST" action="logic_options_addBank.php">
					    <div class="modal-body">
				     		...
				     		<div align="left">
				     			...
				     			<input type="radio" value="0074D9" name="color[]"> <span class="swatch_1"></span> <span class="color_font">Blue</span><br>
				     			<input type="radio" value="2ECC40" name="color[]"> <span class="swatch_2"></span> <span class="color_font">Green</span><br>
				     			<input type="radio" value="FF851B" name="color[]"> <span class="swatch_3"></span> <span class="color_font">Orange</span>
				     		</div>
				     	</div>
